...
const TechStack = () => {
  return (
    <section id="techstack" className="bg-[#fdf6ec] py-16 px-4 text-[#3b3a30]">
      <h2 className="text-3xl font-bold text-center text-[#567568] mb-10">Tech Stack</h2>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
        {techStacks.map((tech, index) => (
          <div
            key={index}
            className="group flex flex-col items-center justify-center bg-[#e8d8c3] text-[#567568] p-6 rounded-xl shadow-md transition-all duration-300 hover:scale-110 hover:bg-[#d7c5aa]"
          >
