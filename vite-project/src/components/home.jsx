...
const Home = () => {
  return (
    <section
      id="home"
      className="bg-[#fdf6ec] text-[#3b3a30] min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden"
    >
      <div className="flex flex-col items-center text-center gap-8 max-w-3xl w-full relative z-20">
        ...
        <div>
          ...
          <p className="text-md text-[#4f4e4c] mb-8 font-medium">
          ...
          <a
            href="#contact"
            className="inline-block bg-[#567568] text-[#fdf6ec] px-8 py-3 rounded-xl font-bold shadow-lg hover:bg-[#4a6559] transition-colors hover:shadow-xl hover:-translate-y-1 transform duration-200"
          >
            Let's Connect
          </a>
        </div>
